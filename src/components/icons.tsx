...
export function DownloadIc(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      strokeWidth='1.5'
      viewBox='0 0 24 24'
...
export function CloudinaryIc(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='156'
...
export function AddIc(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      strokeWidth='1.8'
      viewBox='0 0 24 24'
...
export function ArrowRightIc(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      strokeWidth='1.8'
      viewBox='0 0 24 24'
